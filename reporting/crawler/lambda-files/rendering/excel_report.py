...
class ExcelReport:
    ...
    def create_excel(self):
        ...
        headers_assignments = ['Account-ID', 'Account-Name', 'PermSet-Name', 'Group-Name', 'User-Name', 'User-Display-Name', 'Group-ID', 'User-ID']
        ...
        worksheet_assignments.autofilter(0, 0, 0, len(headers_assignments) - 1)  # Apply filter to the header row
            ...
            for permission_set_name, permission_set_info in account_info['permission_sets'].items():
                ...
                for group_id in permission_set_info['groups']:
                    ...
                    for user_id in group_details.get('assigned_users', []):
                        ...
                        worksheet_assignments.write_row(row_num, 0, [
                            account_id, account_info['account_name'], permission_set_name,
